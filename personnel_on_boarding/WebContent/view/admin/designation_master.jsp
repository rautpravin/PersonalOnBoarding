...
<head>
	...
	<script src="/personnel_on_boarding/res/custom/js/designation.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 master-header-container">
				<label class="master-table-label">Designation Master</label>
				<button type="button" id="btnAdd" class="btn btn-primary pull-right">Add</button>
			</div>
		</div>
		
		<div class="row">
			<div class="table-responsive" id="table-space-designation">
				
			</div>
		</div>
		
	<!-- form -->
		<div id="modaldesignationform" class="modal fade">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button type="button" class="close" onclick="closeForm()">&times;</button>
	                <h4 class="modal-title" id="industry-form-title" >Designation</h4>
	            </div>
	            <div class="modal-body">
	            	<form id="form-designation" onsubmit="return false;">
	           	 	<div class="form-group">
	            		<label>Designation Name *</label>
	            		<input type="text" class="form-control manditory" name="designation-name" id="designation-name"/>
	            	</div>
