...
<head>
	...
	<script src="/personnel_on_boarding/res/custom/js/industry.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 master-header-container">
				<label class="master-table-label">Industry Master</label>
				<button type="button" id="btnAdd" class="btn btn-primary pull-right">Add</button>
			</div>
		</div>
		
		<div class="row">
			<div class="table-responsive" id="table-space-industry">
				
			</div>
		</div>
		
	<!-- form -->
		<div id="modalindustryform" class="modal fade">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button type="button" class="close" onclick="closeForm()">&times;</button>
	                <h4 class="modal-title" id="industry-form-title" >State</h4>
	            </div>
	            <div class="modal-body">
	            	<form id="form-industry" onsubmit="return false;">
	           	 	<div class="form-group">
	            		<label>Industry Name *</label>
	            		<input type="text" class="form-control manditory" name="industry-name" id="industry-name"/>
	            	</div>
