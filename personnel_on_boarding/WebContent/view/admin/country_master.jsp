...
<head>
	...
	<script src="/personnel_on_boarding/res/custom/js/country.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 master-header-container">
				<label class="master-table-label">Country Master</label>
		...
		<div class="row">
			<div class="col-lg-lg-12">
				<div id="table-space-country" class="table-responsive">
				</div>
			</div>
		</div>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	                ...
	                <h4 class="modal-title" id="country-form-title">Country</h4>
	            </div>
	            <div class="modal-body">
	            	<form id="form-country" onsubmit="return false;">
	           	 	<div class="form-group">
	            		<label>Country Name *</label>
	            	<input type="text" name="country" id="countryName" class="form-control manditory" />
	            	</div>
